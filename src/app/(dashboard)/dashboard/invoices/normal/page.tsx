...
export default function NormalInvoicesPage() {
    ...
    const fetchNormalInvoices = async () => {
        try {
            setLoading(true)
            ...
            console.error('Error fetching Normal invoices:', error)
        } finally {
            setLoading(false)
        }
    }
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Facturas Normales</h1>
                    <p className="text-sm text-gray-500 mt-1">
                        <span className="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-gray-100 text-gray-600">
                            Uso Interno - NO reporta a DIAN
                        </span>
                    </p>
                </div>
                <Link
                    href="/dashboard/invoices/normal/new"
            ...
            <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                {loading ? (
                    ...
                    <div className="p-12 text-center">
                        ...
                        <h3 className="text-lg font-medium text-gray-900">No hay facturas normales</h3>
                        <p className="mt-1 text-gray-500">Crea tu primera factura para uso interno</p>
                        <Link
                            href="/dashboard/invoices/normal/new"
